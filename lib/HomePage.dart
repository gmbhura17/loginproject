...
import 'package:loginproject/LoginPage.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: Padding(
        ...
        child: Column(
          children: [
            Text("Login Page Using MVVM", style: TextStyle(fontSize: 20),),
            SizedBox(height: 15,),
            Text("My Button", style: TextStyle(fontSize: 20),),
            SizedBox(height: 15,),
            Text("Style Resources", style: TextStyle(fontSize: 20),)
          ],
        ),
      )),
    );
